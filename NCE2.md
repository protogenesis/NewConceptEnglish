...
一般现在时表示经常发生的事或动作,常常与频率副词相连用,例如: always,sometimes,often,rarely,frequently,等,同时主语和谓语动词要保持一致

现在进行时表示正在进行的动作,动词需要变成现在分词形式,常跟now或根据文章上下文使用

##### 感叹句

感叹句以what/how开头,what+不定冠词+形容词+名词(+主语+be动词)组成,如果形容词也省略了一般表示不好的一面
...
当一个名词(或名词短语)与另一个名词(或名词短语)相连接时,后面的名词起到补充意义的作用
...
结构: sb have/has never done sth, so sb is/am finding sth very adj. 
...
>  **以句号结尾表示一句话,如果中间用逗号相连说明话还没说完,通过连接的时候一定要有连接词**
...
一般过去时表示过去发生过的某件事情或动作,结构为was/were + 动词的过去式
...
有些动词的后面加上介词或者是副词就变成了短语动词,词义也发生改变,需要根据文章上下文的语境来判断在句子中的意思,如果判断加的是介词还是副词,如果后面有跟宾语就是介词.
...
make一般解释为: 做出,制造,做; build一般解释为建筑方面的建造,建设等
...
双重所有格of和's,of一般表示没有生命的物体,'s表示有生命的. 名词的变化规则见13课
...
当一个副词有be动词连用时,他的意思会发生变化(主要由副词的意义决定)
...
名词双重所有格的规则: 一般都是加's, 只有在复数名词以s结尾时加 '

1. 在单数名词后加's

2. 在复合型名词前看情况两个名词都加's或者最后一个加's

   例如: Rechel's apartment and Monica's apartment   瑞秋的公寓和莫妮卡的公寓

   ​	  Rechel and Monica's apartment	瑞秋和莫妮卡的公寓
...
过完完成时表示在过去的某个时间点之前就已经完成过去的过去,通常与一般过去式连用,常与过去完成时的句子连用的时间短语有: as soon as, after, when等
...
直接引语就是直接引述别人的话,不需要对原话进行变动,转述时加引号,结束加标点

间接引语就是转述别人的话,转述时,要根据主句的时态改变间接引语的时态和人称,值得注意的是: 如果转述的是一条普遍存在的真理,间接引语要用一般现在时,在转述时注意连接动词的使用
...
example: He won't pass the exam if he doesn't work harder.
...
can最常用,也最不正式,could一般用在不能确定是否得到肯定回答的时候,同时could也是can的过去式
...
> 大多数现在分词和许多过去分词都可以作为形容词用,常见的以-ed和-ing结尾的成对的形容词有excited/exciting, interested/interesting等,以-ed结尾的形容词常常与人称主语连用,表示人的情绪,状态,喜好等; 以ing结尾的形容词常与非人称主语连用,表明书无语的某种特征,性质
...
一般现在时用于描述经常发生的动作,或普遍性的情况和真理,普遍性的情况一般不用频率副词

可以和频率副词连用,当主要是第三人称单数时,谓语动词和助动词也需要变换
...
两者都有敲打,撞击的意思,beat表示持续性的,有节奏的,例如心脏的跳动,knock表示短暂的
