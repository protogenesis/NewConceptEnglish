...
特殊疑问句的结构一般为: 特殊疑问词+助动词+主语+实义动词

##### 不定冠词

不定冠词只能用来表示名词的单数,以元音开头的需要用an,其他用a
...
祈使句的主语通常省略,谓语动词用原型,表示请求,建议,命令等
...
定冠词没有格,时态的变化,在辅音前发/ðə/音,在元音前发/ði:/音
...
现在进行时通常表示当前正在发生的事情,结构为be+v.ing形式,如果动词是以e结尾的,去掉e再加ing
...
一般现在时通常表示某件事情经常发生,一个习惯,有规律的行为以为永恒的现象,一般与频度副词和时间短语相连用
...
在某个终点的1-30分钟内,一般用past来表达,如果是30-下一个整点,通常用to来表达
...
一般过去时通常表示发生在过去的某件事情,已经结束的动作,一般过去式的表现形式为be动词改为was/were

单数用was复数用were,一般与时间短语相连用
...
副词通常用来修饰某个动词,说明动词发生的情况

副词的变化规则:

+ 一般直接加ly
+ 如果以y结尾,y变成i再加ly
+ 如果以辅音+e/ue结尾,要去掉e再加y/ly
+ 不规则的变形
...
现在完成时的疑问式是将have/has提到,句首,后面语序不变,否定句是在have/has后加not
...
一般将来时表示将来某一时刻的动作.状态以及打算,一般与表示将来意思的事件状语连用

例如: tomorrow,this month, the day after tomorrow, next wee, in tow days' time,from now on(从现在起)
...
在英语中,当一个动词紧跟另一个动词时,需要用动词不定式to相连接,to后面用动词的原型
...
过去完成时表示两个时间中一个发生在前,或者说是表示较早的过去,常与现在完成时连用的事件副词也常与过去完成时连用
...
定语从句有关系代词引导,紧跟在它所修饰的成分后面,关系代词有who,whose与that修饰人,which与that修饰东西(that通用),关系代词指代从句的主语或宾语,连接主句和从句

定语从句中的省略:

当关系代词代表主语并且从句中的谓语动词为现在进行时时,关系代词和be动词均可以省略,如果关系代词在从句中做宾语,则往往可以省略,另外,定语从句可用介词结尾
...
如果表示对过去的猜测和推断,可以用must have been/can't have beenl来表示
...
在间接引语里常要改变时态,因为原来讲的话语转述这些话之间有一段间隔,选择哪种恰当的形式取决于转述折的着眼点
...
宾语从句除了用that,which,whom引导外,还可以用when,where,what,why,how,if,whether来引导,他们在句中往往不能省略,宾语从句通常都应以称述句的形式出现
