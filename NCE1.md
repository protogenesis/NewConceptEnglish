...
单数用was复数用were,当疑问句主语是you时,be动词用were而不是was. 一般与时间短语相连用
...
定语从句由关系代词引导,紧跟在它所修饰的成分后面,关系代词有who,whose与that修饰人,which与that修饰东西(that通用),关系代词指代从句的主语或宾语,连接主句和从句
...
宾语从句除了用that,which,whom引导外,还可以用when,where,what,why,how,if,whether来引导,他们在句中往往不能省略,宾语从句通常都应以陈述句的形式出现
